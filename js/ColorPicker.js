...
$.extend(ColorPickerInstance.prototype, {
	...
	_generateColorPicker: function() {
        ...
        var width = 18;
	    var html = "<table border='0px' cellspacing='0' cellpadding='0'>";
		...
		html += '<tr><td title="" style="background-color:#999" class="color" colspan="' + width + '" align="center"><label>Zgjidh ngjyren</label></td></tr>'
